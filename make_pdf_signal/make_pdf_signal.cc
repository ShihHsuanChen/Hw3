...
int main(){
  ...
  TFile* fin  = new TFile("/home/user/workspace/projects/StatisitcParticle_HW_executable/Hw3/example_signal.root","READ");
  TFile* fout = new TFile("/home/user/workspace/projects/StatisitcParticle_HW_executable/Hw3/PDF/PDF_signal.root","RECREATE");
  ...
  RooRealVar    mu2("mu2","mu2",5.25,5,5.8);
  RooRealVar    mu3("mu3","mu3",5.25,5,5.8);
  RooRealVar    sigma1("sigma1","sigma1",0.03,0,0.5);
  RooRealVar    sigma2("sigma2","sigma2",0.03,0,0.5);
  RooRealVar    sigma3("sigma3","sigma3",0.03,0,0.5);
  RooRealVar    frac1("frac1","frac1",0.,1.);
  RooRealVar    frac2("frac2","frac2",0.,1.);
